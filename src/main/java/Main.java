...
50,smart_193_raw,24157811   LOAD&UNL:   Count of load/unload cycles into head landing zone position
        ...
        final double[] lowerThreshold = new double[]{61107137,		155508219,		677129031,		1016,		3026,		5122,		7505,		43,		429,		999,		9493,		1585,		8578,		24423,		48796,		7626,		16671,		26672,		39767,		4,		131078,		262150,		327685,		17,		47,		100,		593,		640,		6709,		22851,		49391,		133530,		718022,		2911961,		5225821,		1690,		7304,		14538,		31424,		1519,		6482,		11906,		29444};
        final double[] upperThreshold = new double[]{155508219,		677129031,		Double.MAX_VALUE,		3026,		5122,		7505,		Double.MAX_VALUE,		429,		999,		9493,		Double.MAX_VALUE,		8578,		24423,		48796,		Double.MAX_VALUE,		16671,		26672,		39767,		Double.MAX_VALUE,		131078,		262150,		327685,		Double.MAX_VALUE,		47,		100,		593,		Double.MAX_VALUE,		6709,		22851,		49391,		Double.MAX_VALUE,		718022,		2911961,		5225821,		Double.MAX_VALUE,		7304,		14538,		31424,		Double.MAX_VALUE,		6482,		11906,		29444,		Double.MAX_VALUE};
