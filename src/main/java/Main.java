...
50,smart_193_raw,24157811   LOAD&UNL:   Count of load/unload cycles into head landing zone position
        ...
        final String[] valuesAR = new String[]{      "R_ERR_0",		"R_ERR_1",		"R_ERR_2",		"R_ERR_3",		"R_ERR_4",		    "SPIN-UP_0",		"SPIN-UP_1",	"SPIN-UP_2",	"SPIN-UP_3",		"SPIN-UP_4",		"S&S_0",		"S&S_1",		"S&S_2",		"S&S_3",		"S&S_4",		    "REALLOC_0",		"REALLOC_1",		"REALLOC_2",		"REALLOC_3",		"REALLOC_4",		"HOURS_0",		"HOURS_1",		"HOURS_2",		"HOURS_3",		"HOURS_4",		    "POWER-CYCL_0",		"POWER-CYCL_1",		"POWER-CYCL_2",		"POWER-CYCL_3",		"POWER-CYCL_4",		"RETRACT_0",		"RETRACT_1",		"RETRACT_2",		"RETRACT_3",		"RETRACT_4",		"LOAD&UNL_0",		"LOAD&UNL_1",		"LOAD&UNL_2",		"LOAD&UNL_3",		"LOAD&UNL_4",		"UNST-SEC_0",		"UNST-SEC_1",		"UNST-SEC_2",		"UNST-SEC_3",		"UNST-SEC_4",		"ABS-ERR_0",		"ABS-ERR_1",		"ABS-ERR_2",		"ABS-ERR_3",		"ABS-ERR_4"};
        final double[] lowerThreshold = new double[]{1,		        14534767,		38187921,		62320436,		86247183,		    1,		            430,		    509,		    594,		        966,		        1,		        4,		        9,		        17,		        28,		            1,		            188,		        549,		        923,		        1259,		        1,		        1408,		    2960,		    4543,		    5978,	            1,		2,		4,		6,		9,		1,		28,		103,		220,		417,		1,		7753,		22808,		42459,		73266,		1,		98,		304,		617,		1110,		1,		90,		258,		479,		740};
        final double[] upperThreshold = new double[]{14534767,		38187921,		62320436,		86247183,		Double.MAX_VALUE,	430,		        509,		    594,		    966,		        Double.MAX_VALUE,	4,		        9,		        17,		        28,		        Double.MAX_VALUE,	188,		        549,		        923,		        1259,		        Double.MAX_VALUE,   1408,		    2960,		    4543,		    5978,		    Double.MAX_VALUE,	2,		4,		6,		9,		Double.MAX_VALUE,		28,		103,		220,		417,		Double.MAX_VALUE,		7753,		22808,		42459,		73266,		Double.MAX_VALUE,		98,		304,		617,		1110,		Double.MAX_VALUE,		90,		258,		479,		740,		Double.MAX_VALUE};
        final int[] columnIndex = new int[]{         6,		        6,		        6,		        6,		        6,		            10,		            10,		        10,		        10,		            10,		            12,		        12,		        12,		        12,		        12,		            14,		            14,		            14,		            14,		            14,		            20,		        20,		        20,		        20,		        20,		            26,		26,		26,		26,		26,		48,		48,		48,		48,		48,		50,		50,		50,		50,		50,		58,		58,		58,		58,		58,		60,		60,		60,		60,		60};
