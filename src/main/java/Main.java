...
50,smart_193_raw,24157811   LOAD&UNL:   Count of load/unload cycles into head landing zone position
        ...
        final double[] lowerThreshold = new double[]{    500000,              250,                10,                 4,                    10,                  4000,                3,                   5,                      12,                     4,                 7,                   5000,              3,                   10,                    3,                   10               };
        final double[] upperThreshold = new double[]{    Double.MAX_VALUE,    Double.MAX_VALUE,   Double.MAX_VALUE,   10,                   Double.MAX_VALUE,    Double.MAX_VALUE,    Double.MAX_VALUE,    12,                     Double.MAX_VALUE,       7,                 Double.MAX_VALUE,    Double.MAX_VALUE,  10,                  Double.MAX_VALUE,      10,                  Double.MAX_VALUE };
